...
public class UserDaoHibernateImpl implements UserDao {
    ...
    private String sqlCreateUserTable = "CREATE TABLE IF NOT EXISTS usersTable (id BIGINT PRIMARY KEY AUTO_INCREMENT, " +
    ...
    public void cleanUsersTable() {
        ...
        try (Session session = sessionFactory.openSession()) {
            transaction = session.beginTransaction();
            session.createSQLQuery(sqlClearUserTable).executeUpdate();
            transaction.commit();
